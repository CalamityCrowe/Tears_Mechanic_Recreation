...
void ATears_RecreationCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Toggle Rotate", IE_Pressed, this, &ATears_RecreationCharacter::EnableObjectRotation);
	PlayerInputComponent->BindAction("Toggle Rotate", IE_Released, this, &ATears_RecreationCharacter::DisableObjectRotation);
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Mouse", this, &ATears_RecreationCharacter::AddControllerYawInput);
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ATears_RecreationCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Mouse", this, &ATears_RecreationCharacter::AddControllerPitchInput);
...
void ATears_RecreationCharacter::AddControllerPitchInput(float Rate)
{
	if (Rate != 0 && Controller && Controller->IsLocalPlayerController())
	{
		if (m_RotateGrabbed && m_AttachToggle) // checks if it should rotate the object held and if the ability is active
